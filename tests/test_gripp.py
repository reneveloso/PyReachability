...
from pyreachability import Graph, GRIPP, catalog
...
def test_errors_and_registration():
    ...
    with pytest.raises(IndexError):
        idx.query(0, 99)
    assert "gripp" in catalog.methods()
    assert catalog.get("gripp") is GRIPP
