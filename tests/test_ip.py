...
from pyreachability import Graph, IP, catalog
...
@given(digraphs(), st.integers(1, 3), st.integers(1, 3))
def test_ip_matches_oracle(g, k, npn):
    n, edges = g
